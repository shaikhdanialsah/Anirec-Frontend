...
function AboutDescription() {
  ...
  return (
    <Row style={{paddingRight:'30px', paddingLeft:'30px',margin:'auto', paddingTop:'100px', paddingBottom:'70px'}} ref={ref}>
      <Col lg={6} style={{overflow:'hidden'}}><img src={anime_about} style={{height:'120%', width:'100%', borderRadius:'10px'}}></img></Col>
      <Col lg={6}>
      <motion.h2 style={{color:'whitesmoke', paddingLeft:'10px', paddingBottom:'20px', paddingTop:'20px'}}
      initial="hidden"
            animate={controls}
            variants={fadeIn}
